...
<div class="review-form-container">
    ...
    <form id="reviewForm" class="review-form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="reviewTitle" name="title" value="${review.title}" placeholder="리뷰 제목을 입력하세요">
        </div>
        ...
        <div class="form-group">
            ...
            <div id="imagePreview" class="image-preview">
                <!-- 가져온 reivew 중에 이미지가 존재하면 미리보기 이미지 출력 -->
                <c:if test="${not empty review.imageUrl}">
                    <img src="${review.imageUrl}" alt="Review Img">
                </c:if>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="reviewContent" name="content" rows="6" placeholder="리뷰를 작성하세요">${review.content}</textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input class="insert_btn" type="button" value="리뷰 수정" onclick="updateReview(this.form)">
        </div>
    </form>
</div>
